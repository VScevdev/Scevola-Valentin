"""
Django settings for fluxoria project.
...
SECRET_KEY = 'django-insecure-(cmf)pi!!e%86nx*+9j2)*nce_w3-z2x+sdfighjbxvhkjd5%)'
...
WSGI_APPLICATION = 'fluxoria.wsgi.application'
